...
var variable = $('#trama').toggleClass();
	...
	$(window).load(function(){
        ...
        $('.nav-colapse').mCustomScrollbar(); 
       	...
       	var classAdd = $('.nav-colapse .contendor-menu .menu ul li:first-child, .content-single a .pattern, .footer-container .content-right .pattern, .search-loop .title-resultado .pattern, .content-float  .btn-left .pattern, .page-contacto .form-contacto-cont .cont-pattern, .page-specs .acordeon .title-acor');
