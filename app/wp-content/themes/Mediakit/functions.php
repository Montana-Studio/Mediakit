...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/jquery.mCustomScrollbar.concat.min.js', array()); // Custom scroll 
        
        wp_register_script('html5blankscripts', get_template_directory_uri() . '/js/mediakit.min.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('html5blankscripts'); // Enqueue it!
    }
}
...
function html5blank_styles()
{
    ...
    //wp_register_style('html5blank', get_template_directory_uri() . '/mediakit.css', array(), '1.0', 'all');
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        ...
        'cat-menu' => __('Category menu', 'html5blank') // Extra Navigation if needed (duplicate as many as you need!)
    ));
}
...
if (function_exists('register_sidebar'))
{
    ...
    register_sidebar(array(
        ...
        'after_title' => '</span><div class="line"></div></h3><div style="clear:both"></div>'
    ));
}
...
function my_theme_wrapper_start() {
  echo '<section class="content" id="main">';
}
