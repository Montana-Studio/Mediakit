...
<?php endif; ?>
		...
		<h2><span><?php _e( 'Login', 'woocommerce' ); ?></span><div class="line"></div></h2>

		<form method="post" class="acc-login">
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="content-signin">
		...
		<h2><span><?php _e( 'Register', 'woocommerce' ); ?></span><div class="line"></div></h2>

		<form method="post" class="acc-register">
