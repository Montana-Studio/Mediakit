                ...
                <div class="content-sitio">
                    ...
                    <div class="metrics">
                        ...
                        <div id="results_metrics" class="metrica-number">
                            <div class="content-metricanumber">
                                <ul>
                                    <h3 class="bg-highlight">Social Media</h3>
                                    <div class="content-metricsnumbers">
                                        <li>
                            ...
                            <div class="content-display">
                                ...
                                <div class="content-marketplace">
                                   <?php
                                     ...
                                     $productos_prueba1 = '[wcv_recent_products vendor="VENDOR-LOGIN-NAME" per_page=3]';

                                     echo do_shortcode( $productos_prueba1 );
