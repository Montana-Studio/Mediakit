<?php /*Template name: Pagina Fashion*/ ?>
...
<?php get_template_part('menu'); ?>
	...
	<!-- section -->
		<div class="page-categoria">
			...
			<!-- LOOP -->
				<?php $query = new WP_Query('posts_per_page=10&category_name=fashion'); ?>
					...
					<div class="sitio-single">
						<div class="content-single">
							<a href="<?php the_permalink()?>">
								...
								<div class="content-pattern-trama"><div class="bg-highlight-inv"><i class="fa fa-area-chart"></i> MONTHLY REACH <?php the_field('reach_sitio'); ?></div></div>
